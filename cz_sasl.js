...
ChatZilla is a clean, easy to use and highly extensible Internet Relay Chat (IRC) client. Get it here: https://addons.mozilla.org/addon/16
...
function initPlugin(glob){    
    ...
    plugin.prefary = plugin.prefary.concat([
     ["sasl.servername", "irc.wirelesspt.net"],
     ["sasl.username",""],
     ["sasl.password",""],
